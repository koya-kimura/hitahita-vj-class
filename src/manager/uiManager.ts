...
import type { UIDrawFunction } from "../ui/uiDrawers.ts"; // UI描画関数の型定義
import { UI_PATTERNS } from "../ui/uiDrawers.ts"; // UI描画関数の実装

// UI描画関数の配列。MIDI入力に基づいて選択される。
const UI_DRAWERS: readonly UIDrawFunction[] = UI_PATTERNS;
